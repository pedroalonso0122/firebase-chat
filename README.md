...
let channel = RSChatChannel(id: "channel_id", name: "Chat Title")
let viewer = RSUser(firstName: "Florian", lastName: "Marcu")
let chatVC = RSChatThreadViewController(user: viewer, channel: channel, uiConfig: uiConfig)
